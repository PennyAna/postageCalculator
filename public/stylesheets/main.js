...
document.getElementById('postageType').addEventListener('change', setInputMax(postal_type));
...
function setInputMax(type) {
    document.getElementById('waitingForWeights').innerHTML = 
    "<%- include('partials/postage_weight.ejs') %>";
    switch(type) {
        case 1, 2: 
            set_max = 3.5;
            set_step = .5;
